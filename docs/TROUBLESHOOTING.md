...
Nao e falha de build. A fundacao LogiDesk existe, mas o produto empresarial completo ainda nao inclui SSO frontend real, consumo Socket.IO no browser, E2E completo, SLA avancado, anexos binarios e dispatcher completo de outbox/DLQ. Ver `docs/LOGIDESK.md`.
