...
Nao e falha de build. A fundacao LogiDesk existe, mas o produto empresarial completo ainda nao inclui SSO real, Socket.IO autenticado, E2E completo, SLA avancado, anexos e dispatcher completo de outbox/DLQ. Ver `docs/LOGIDESK.md`.
