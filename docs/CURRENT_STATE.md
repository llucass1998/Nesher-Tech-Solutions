...
- Web com login Identity inicial, dashboard, chamados, detalhe do chamado, Kanban, SLA e configuracoes.

Limitacoes:

- SSO/JWKS basico conectado ao LogiIdentity por `GET /api/v1/auth/me` e login inicial no LogiDesk web.
